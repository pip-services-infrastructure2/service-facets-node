# Deployment Guide <br/> Facets Microservice

Facets microservice can be used in different deployment scenarios.
...
Tthe Facets microservice can also be used as a Seneca plugin.
...
var plugin = require('service-facets-node').FacetsSenecaPlugin;
...
or by using [FacetsSenecaClient](https://github.com/pip-services/client-facets-node/NodeClientApiV1.md/#client_seneca)